...
public class RestControllerAdvisor extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> customExceptionHandling(CustomValidationException ex,
                                                          WebRequest request) {
    ...
    @ExceptionHandler({CredenciaisInvalidasException.class, InvalidTokenException.class
    })
